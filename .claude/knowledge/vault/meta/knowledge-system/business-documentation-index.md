...
tags:
  ...
  - business-index
description: >-
  Index of business domain documentation in docs/business/ (risk, tokenization,
  trading).
...
**DEPRECATED APPROACH:** This document described business docs in `docs/business/`.

**CURRENT ARCHITECTURE:** Business knowledge now lives in `.claude/knowledge/vault/business/` as part of the knowledge vault.

See `knowledge-namespace-architecture.md` for current namespace structure and rationale.

## Historical Context (Docs Approach - No Longer Used)

Originally, business domain documentation was planned for `docs/business/` to ensure:
...
**Why changed:** Git submodule strategy requires business knowledge in vault for cross-repo propagation.
