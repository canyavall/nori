...
tags:
  - kv-knowledge
  - kv-dependencies
  - kv-required-knowledge
  - kv-knowledge-validation
  - knowledge-deps
  - vault-dependencies
description: >-
  How to set required_knowledge dependencies when creating or splitting
  knowledge packages. Needed when a guide references concepts from other guides.
required_knowledge:
  - create-knowledge
---
...
node .claude/kv/scripts/knowledge-search.mjs --tags sygnum-query
```
