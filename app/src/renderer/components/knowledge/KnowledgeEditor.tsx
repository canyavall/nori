...
${markdownContent}`;
  ...
  const handleSave = async () => {
    try {
      ...
      // Note: Knowledge editing not implemented in MVP
      // See MIGRATION.md: Known Limitations #1
      console.warn('Knowledge package saving not supported in MVP');

      // Stub: No backend support for saving packages
      throw new Error('Package saving not implemented in MVP');
