...
export const TopNav = () => {
  ...
  return (
    <nav class="flex items-center px-6 py-3 border-b border-[var(--color-border)] bg-[var(--color-bg)] flex-shrink-0">
      <span class="text-[var(--color-text)] font-semibold text-xl mr-8">Nori</span>
