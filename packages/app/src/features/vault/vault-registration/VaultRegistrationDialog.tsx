...
import { VaultTypePicker } from './VaultTypePicker';
import { VaultRegistrationForm } from './VaultRegistrationForm';
import { VaultRegistrationResult } from './VaultRegistrationResult';
